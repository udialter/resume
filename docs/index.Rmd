...
<center>
![Udi Alter](https://beatrizmilz.com/about/sidebar/avatar.jpeg){width=80% style='border-radius: 50%;'}
</center>
...
<i class="fa fa-envelope"></i> udialter@yorku.ca
...
<i class="fab fa-researchgate"></i> [researchgate.net/profile/Udi-Alter](https://www.researchgate.net/profile/Udi-Alter)
